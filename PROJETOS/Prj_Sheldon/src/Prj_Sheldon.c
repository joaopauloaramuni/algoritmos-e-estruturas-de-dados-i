...
//Um número de Sheldon, também conhecido como número de Smith,
//é um número composto cuja soma dos dígitos é igual à soma dos dígitos dos seus fatores primos.
//Para determinar se um número 𝑛 n é um número de Sheldon, você pode seguir os seguintes passos:
...
// Exemplos de números de Sheldon: 4, 22, 27, 58, 85, 94
...
// Função principal para verificar se um número é um número de Sheldon
int eh_numero_sheldon(int num) {
...
int main(void) {
    ...
    scanf("%d", &num);
    if (eh_numero_sheldon(num)) {
        printf("%d é um número de Sheldon.\n", num);
    } else {
        printf("%d não é um número de Sheldon.\n", num);
    }
    return 0;
}
