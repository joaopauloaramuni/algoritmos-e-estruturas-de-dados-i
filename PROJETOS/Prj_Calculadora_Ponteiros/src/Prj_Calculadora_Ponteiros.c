...
// Procedimento que calcula a soma de dois números usando ponteiros
...
// Procedimento que calcula a diferença entre dois números usando ponteiros
void diferenca(int *x, int *y, int *resultado) {
    *resultado = *x - *y;
}

// Procedimento que calcula o produto de dois números usando ponteiros
void produto(int *x, int *y, int *resultado) {
    *resultado = *x * *y;
}

// Procedimento que calcula o quociente de dois números usando ponteiros
